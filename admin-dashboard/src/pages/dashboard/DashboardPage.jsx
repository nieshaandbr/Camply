...
export default function DashboardPage() {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      const activePosts =
        posts?.filter((p) => !p.expires_at || p.expires_at > now) || [];
  ...
  const showGuide = isLoaded && !seenGuides.admin_dashboard;
        ...
        steps={[
          {
            heading: 'Overview',
            description:
              'This dashboard gives you a quick summary of your university activity, including posts and applications.',
          },
          {
            heading: 'Stats Cards',
            description:
              'Use these cards to track how many posts are live, how many applications came in, and which ones are accepted, rejected, or pending.',
          },
          {
            heading: 'Recent Activity',
            description:
              'These sections help you quickly review your latest posts and the most recent student applications.',
          },
        ]}
        onFinish={() => markGuideSeen('admin_dashboard')}
      />
